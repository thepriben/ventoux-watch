...
const COPY = {
  en: {
    ...
    relief: "Relief",
    reliefText: "The ground the watcher reads, unfolded. Drag to turn, scroll to zoom.",
  ...
  fr: {
    ...
    relief: "Relief",
    reliefText: "Le sol que la machine lit, déplié. Glisser pour tourner, molette pour zoomer.",
